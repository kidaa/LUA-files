...
function init_gear_sets()
    ...
    sets.resting = {head="Melee crown",neck="Chocobo whistle",
        body="Melee cyclas",ring1="Flame ring",ring2="Ecphoria Ring", ammo="Bibiki seashell", ear1="Intruder earring", ear2="Cassie earring", hands="Melee gloves",
    ...
    sets.engaged = {head="Walahra turban",neck="Peacock amulet",
        body="Scorpion harness +1",ring1="Flame ring",ring2="Ecphoria Ring", ammo="Bibiki seashell", ear1="Intruder earring", ear2="Cassie earring", hands="Melee gloves",
		back="Amemet mantle +1", waist="Brown belt", legs="Byakko's haidate", feet="Sarutobi kyahan"}
